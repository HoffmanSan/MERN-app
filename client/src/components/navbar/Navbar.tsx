  ...
  return (
    <nav className="sticky top-0 z-10 bg-orange-400">
      <ul className="z-10 flex w-9/12 py-2 mx-auto">
        ...
        <li id="account" className="px-1" onClick={() => setToggleOpen(true)} >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="white" className={`m-1 cursor-pointer transition duration-300 w-7 h-7 hover:scale-125 focus:scale-125 ${toggleOpen ? "scale-125" : ""}`}>
