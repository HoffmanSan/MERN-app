  ...
  return (
    <>
      {categoryProducts.length !== 0 ? 
        <>
          <div className="w-3/12 p-3 mx-auto mt-6 bg-white shadow-md">
            ...
            <form className="text-center">
              ...
              <input 
                type="number"
                placeholder="od"
                className="w-3/12 px-2 py-1 my-1 border border-black"
          ...
          <div className="grid w-9/12 grid-cols-5 px-5 py-3 mx-auto my-6 bg-white shadow-md">
            <h2 className="col-span-5 text-center">Produkty z kategorii: {categoryName}</h2>
            {categoryProductsFilteredByPrice.length === 0 ?
              minPrice === 0 && maxPrice === 99999 ?
                <h3 className="col-span-5 mt-5 text-center text-gray-400">Ładowanie...</h3>
              :
                <h3 className="col-span-5 mt-5 text-center text-gray-400">Brak produktów spełniających podane kryteria</h3>
            :
      ...
      :
        <h3 className="mt-5 text-center text-gray-400">Brak produktów z tej kategorii</h3>
      }
    </>
  )
}
